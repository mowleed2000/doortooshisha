...
index_html = get_header("home") + """
    ...
    <section style="background: #0B0D13;">
        ...
        <div class="exp-grid">
            ...
            <div class="exp-card">
                <img src="assets/images/shisha/experience/E03.png" class="exp-img" alt="E03 Private Gathering">
                <div class="exp-body">
                    <h4>MAYFAIR GATHERING</h4>
                    <p>Small private gathering at 11pm with friends.</p>
                </div>
            </div>
        </div>
    </section>
